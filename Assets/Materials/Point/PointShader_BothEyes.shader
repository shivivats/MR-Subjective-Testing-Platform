...
Shader "Point Cloud/PointShader_BothEyes"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        Pass
        {
        ...
        #endif
            {
                ...
                UNITY_INITIALIZE_OUTPUT(Varyings, o); // Added to enable display on both hololens eyes
                UNITY_INITIALIZE_VERTEX_OUTPUT_STEREO(o); // Added to enable display on both hololens eyes
